...
if(!empty($_POST))
{
	...
	if($name!="")
	{
		$newMaterial = new Material($bdd);

		if($newMaterial->existMaterial($name)==1)
		{
			$error = "Your material already exist";
			$class_message = "error";
		}
		else
		{
			$newMaterial->addMaterial($name);

			$error = "Your material has been created";
			$class_message = "validate";
		}
	}
	else
	{
		$error = "You must add a material name";
		$class_message = "error";		
	}
...
<body>
	<header class="admin">
        ...
        <li>
          <a href="admin.php">STYLES</a>
          <div class="cbp-hrsub">
            <div class="cbp-hrsub-inner"> 
              <div class="liste-submenu">
                <h4>style settings</h4>
                <ul>
                  <li><a href="add_style.php">Add a material</a></li>
                  <li><a href="edit_style.php">Edit a material</a></li>
                </ul>
              </div>
            </div><!-- /cbp-hrsub-inner -->
          </div><!-- /cbp-hrsub -->
        ...
        <li>
          <a href="admin.php?form=Materials">MATERIALS</a>
          <div class="cbp-hrsub">
          <div class="cbp-hrsub-inner"> 
            <div class="liste-submenu">
