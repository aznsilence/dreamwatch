...
if(!empty($_POST))
{
	...
	if($name!="")
	{
		...
		$newCategory->addCategory($name);

		$error_cat = "Your category has been created";
		$class_message = "validate";
	}
	else
	{
		$error_cat = "You must add a category name";
		$class_message = "error";		
	}
...
<body>
	...
	<main>
		...
		<div class="container admin">
			...
			<br/>
			<?php
			if(isset($error_cat) && $error_cat != "")
			{
				echo "<span class='".$class_message."'>".$error_cat."</span>";
			}
			?>					
			...
			<form action="add_category.php" method="POST">
				...
				<input type="text" name="name" id="categories" value="" />
				<br/>
				<br/>
